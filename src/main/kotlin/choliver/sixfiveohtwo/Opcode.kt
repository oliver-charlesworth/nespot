...
enum class Opcode(
  ...
  CLC(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.C0__, Stack.NONE, Alu::nop),
  CLD(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.D0__, Stack.NONE, Alu::nop),
  CLI(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.I0__, Stack.NONE, Alu::nop),
  CLV(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.V0__, Stack.NONE, Alu::nop),
  ...
  SEC(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.C1__, Stack.NONE, Alu::nop),
  SED(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.D1__, Stack.NONE, Alu::nop),
  SEI(Reg.Z, AluSrc.ZZZ, AluSrc.ZZZ, OutSrc.ZZZ, Reg.Z, _0, Flag.I1__, Stack.NONE, Alu::nop),
